class CommentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @comment.save
        format.html {redirect_to blog_post_path(id: @comment.blog_post), notice: "Comment was created successfully."}
      else
  ...
  def destroy
    @comment.destroy
    respond_to do |format|
      format.html { redirect_to blog_post_path(id: @comment.blog_post_id), notice: "You're comment was destroyed!"}
    end
  end
